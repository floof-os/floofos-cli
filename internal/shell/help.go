...
func showServiceHelp() error {
	...
	fmt.Println("====================")
	fmt.Println()
	fmt.Println("Usage: service <action> <name>")
	fmt.Println()
	fmt.Println("Actions:")
	fmt.Println("  start <service>       - Start service")
	fmt.Println("  stop <service>        - Stop service")
	fmt.Println("  restart <service>     - Restart service")
	fmt.Println("  status <service>      - Show service status")
	fmt.Println("  enable <service>      - Enable service auto-start")
	fmt.Println("  disable <service>     - Disable service auto-start")
	return nil
}
